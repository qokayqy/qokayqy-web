...
export const translations = {
  en: {
    ...
    about: {
      ...
      mission: "Every business deserves access to great digital tools. We build websites, automation, and software that fit small and mid-sized businesses and actually deliver results.",
  ...
  am: {
    ...
    landing: {
      ...
      stats: [
        { value: "60+", label: "Նախագիծ" },
        { value: "100%", label: "Ժամանակին" },
        { value: "3×", label: "Արագություն" },
    ...
    about: {
      ...
      mission: "Մենք կառուցում ենք կայքեր, ավտոմատացում և ծրագրեր, որոնք իրական արդյունք են տալիս փոքր և միջին բիզնեսներին։",
